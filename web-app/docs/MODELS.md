...
| `gpt-5.2` | GPT 5.2 | OpenAI | OpenAI 原生 | `OPENAI_API_KEY` |
| `kimi-k2.5` | Kimi K2.5 | Moonshot | OpenAI 兼容 | `MOONSHOT_API_KEY` |
| `deepseek-v3.2` | DeepSeek V3.2 | DeepSeek | OpenAI 兼容 | `DEEPSEEK_API_KEY` |
