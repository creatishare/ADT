...
- Name: chat-workspace.spec.ts >> mobile tab switching >> switches to artifact tab and back
- Location: tests/e2e/chat-workspace.spec.ts:131:7
...
Call log:
  - waiting for getByRole('button', { name: /设计文档/ })
